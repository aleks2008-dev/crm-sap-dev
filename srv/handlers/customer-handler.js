...
async function recalculateCustomerMetrics(customerID, { Customer, Feedback, Interaction }) {
...
async function logFeedbackInteractions(customerID, { Feedback, Interaction }) {
...
module.exports = async function () {
    ...
    this.before('SAVE', 'Customers', async (req) => {
        ...
        try {
            const payloadFeedbacks = Array.isArray(req.data.feedbacks) ? req.data.feedbacks : [];
